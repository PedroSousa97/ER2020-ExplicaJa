...
//Rest API route to signup a tutor
...
//Simple route to generate a Teacher registration token
...
router.post("/login",(req,res,next)=>{
  ...
  //Simple route to get the number of all employed teachers
...
//Simple route to get the teacher's data
...
//Simple route to get the number os students
  ...
  //Simple route to get teacher's feedbacks
  ...
  //Route used to delete a teacher
...
//Route used to create teacher's avaluations
...
//Route used to get teacher's avaluations
  ...
  //Route used to change the tutoring payment method
  ...
  //Route used to get student's data by their ID
  ...
  //Route used to get the student presences in classes by ID of the student
  ...
  //Route used to get the payment method using the father ID
  ...
  //Route used to get the total value left to pay by the father of the students
  ...
  //Route used to simulate the payment

...
//Route used to get the total number of available disciplines
  ...
  //Route used to get the disciplines data
  ...
  //Route used to delete descipline by id
...
//Route used to create discipline
  ...
  //Route to get the disciplines of a certain teacher
  ...
  //Get Class Room link by course ID
...
//Get available courses according to the student school year
...
//Get teacher schedules by course ID
...
//Get Course data using the course ID
  ...
  //Get Teachers of a certain school year from a student with ID = parameter
...
//Add class participation to student
  ...
  //Create/Update new Class Room Link
